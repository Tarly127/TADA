...
public class SynchDLPSW86
{
    ...
    {
        System.out.println("SynchDLPSW86 " + ProcessHandle.current().pid());
        ...
        if(processor.isLeader())
        {
            ...
            TestAux.store(execTimes, execWallTimes, metrics,
                    TestConsts.OUTPUT_DIR + "SynchDLPSW86/SynchDLPSW86_leader_" + args[0] + "_" + args[2] +
                            ".csv");
        ...
        else
        {
            ...
            TestAux.store(metrics, TestConsts.OUTPUT_DIR + "SynchDLPSW86/SynchDLPSW86_" + args[0] + "_" + args[2] +
                    ".csv");
