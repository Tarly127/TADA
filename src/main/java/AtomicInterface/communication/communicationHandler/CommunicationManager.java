...
{
    /**
     * Dequeue a message tagged with any of the wanted types. If no such message exists, the method should block until
     * one is available.
     ...
     * message
     */
    Triplet<AddressInterface, byte[], Byte> dequeue(Subscription acceptableTypesReg);
     ...
     */
    void addToGroup(AddressInterface address, ProcessInterface process);
