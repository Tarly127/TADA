        ...
        implements AsyncAtomicApproximateValue<Double>, AsynchronousPrimitive
{
    ...
    @Override
    public SynchronousPrimitive sync()
    {
        return null;
    }
    ...
    private RequestID startNewConsensus    ()
    {
        ...
        ConsensusInstance<Double> consensus
                = new AsynchDLPSW86Instance(snapshot, myReqId, this.instanceID, this.myV.getDouble(), this.messageLogger);
        // Store new snapshot
    ...
    private void handleNew            (ApproximationMessage msg)
    {
        ...
        var consensusInstance
                = new AsynchDLPSW86Instance(snapshot, msg.reqID, this.instanceID, this.myV.getDouble(),
                this.messageLogger);
